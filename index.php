<!DOCTYPE html>
<html>
<title>EMSAD BUSNIESS LAYOUT</title>
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide">EMSAD</a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Start Learning Coding</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Start something that matters</span><br>
    <span class="w3-large">Stop wasting valuable time with projects that just isn't you.</span>
    <p><a href="#about" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Learn how we woyuld help digitized your Business</a></p>
  </div> 
...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-quarter">
      ...
      <p>At Emsad It Solutions, We take our Customers Serious and try to respond to there need appropriately</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-heart w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Exeperience</p>
      <p></p>
    </div>
    <div class="w3-quarter">
...
<div class="w3-container" style="padding:128px 16px" id="team">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="2.jpg" alt="John" style="width:100%">
        <div class="w3-container">
          <h3>Oladokun Samuel</h3>
          <p class="w3-opacity">CEO & Founder</p>
          <p>Meet Oladokun Samuel Temitope, the CEO of EMSAD IT SOLUTIONS Ondo </p>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="7.jpg" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>Adeala Victor</h3>
          <p class="w3-opacity">Art Director</p>
          <p>Victor is an experienced designer with over 5 years of experience</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contact</button></p>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        ...
        <div class="w3-container">
          ...
          <p>Femi, is a well known developer in Ondo State and has over 10years of experience</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contact</button></p>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="4.jpg" alt="Dan" style="width:100%">
        <div class="w3-container">
          <h3>Joseph Fios</h3>
          <p class="w3-opacity">Designer</p>
          <p>Joseph is a senior designer who has worked with different  companies.</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contact</button></p>
        </div>
      </div>
    </div>
